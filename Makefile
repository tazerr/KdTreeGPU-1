...
clean:
	rm -f obj/removeDups.o obj/KdTreeGPUsms.o obj/Gpu.o obj/mergeSort.o obj/buildKdTree.o obj/kdTree0 obj/kdTreeInterp obj/program1 obj/call_kd_tree.mod kdTreeGPUsms 
